...
int32 getAngleAndSetTargetActorDistance(int32 x1, int32 z1, int32 x2, int32 z2) {
  ...
  return (1024 + 256 + ((int32)floor((-1024 * atan2((int64)(z2-z1), (int32)(x2-x1))) / (2*PI)))) % 1024;
}

//  int32 value = (int32)ceil((-1024 * atan2((int64)(z2-z1), (int32)(x2-x1))) / (2*PI));
//  return (value + 1024 + 256) % 1024;
